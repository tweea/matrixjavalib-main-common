...
/**
 * 读取 Properties 格式的配置对象容器。
 */
public class PropertiesConfigurationContainer
    implements ReloadableConfigurationContainer<PropertiesConfiguration> {
    /**
     * 日志记录器。
     */
     ...
     * 配置对象构建器。
     */
    private final ReloadingFileBasedConfigurationBuilder<PropertiesConfiguration> configBuilder;
    ...
    public PropertiesConfigurationContainer() {
        this.configBuilder = new ReloadingFileBasedConfigurationBuilder<>(PropertiesConfiguration.class);
        ...
        PropertiesBuilderParameters configBuilderParameters = buildConfigBuilderParameters();
    ...
    protected PropertiesBuilderParameters buildConfigBuilderParameters() {
        PropertiesBuilderParameters configBuilderParameters = PARAMETERS.properties();
